      ...
      <div className=" flex shadow-xl lg:gap-5  flex-wrap justify-center md:p-10 items-center w-screen">
        {ofertas && ofertas.length > 0 ? (
          ofertas.map((of) => (
            <div
              key={of.id}
              className=" flex flex-col  w-[160px] md:w-[220px] bg-white shawod-md text-center h-[340px] md:h-[380px]   m-1 rounded-t rounded-b-2xl"
            >
              <div className="flex justify-end ">
                ...
                <img
                  className="mx-auto  w-full p-2 h-[200px] md:h-[250px]  object-cover"
                  src={of.imagen_url}
                  alt=""
                />
              </div>
